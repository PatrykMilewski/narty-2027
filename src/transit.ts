...
export const franceAgency = (r: Row) => r[0].includes('Doliny') && r[2] !== 'Samodzielnie';
export function flightTime(r: Row) {
  return franceAgency(r) ? r[2] === 'SnowShow' ? '13–16' : '14–17' : r[5];
}
export function transitDetails(r: Row) {
  if (!franceAgency(r)) return '';
